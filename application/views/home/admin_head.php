			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<!-- pathology menu section -->
						<?php if ($this->ion_auth->in_group('admin')) { ?>
							<li class="submenu">
								<a class="submenu_a " href="#"><i class="fa fa-flask"></i> <span> Pathology </span> <span class="menu-arrow"></span></a>
								<ul class="submenu_ul " style="display: none; margin-left: 30px; ">
									<li><a href="pathology"> Report Entry </a></li>
									<li><a href="pathology/printRepoView"> Report Print </a></li>
									<li><a href="pathology/addInvTests"> Test Info </a></li>
									<li><a href="pathology/test_add"> Test INV Info </a></li>
									<li><a href="pathology/grp_info"> Test Group Info </a></li>
								</ul>
							</li>
						<?php } ?>
						<!-- //  pathology menu section -->
						...
						<?php if ($this->ion_auth->in_group('admin')) { ?>
							<li class="submenu">
								<a class="submenu_a " href="#"><i class="fa fa-flask"></i> <span> USG </span> <span class="menu-arrow"></span></a>
								<ul class="submenu_ul " style="display: none; margin-left: 30px; ">
									<li><a href="usg"> Add Patient Report </a></li>
									<li><a href="print_repo"> Print Report </a></li>
									<li><a href="normal_test"> Test Report </a></li>
								</ul>
							</li>
						<?php } ?>
						<!-- //  USG menu section -->
