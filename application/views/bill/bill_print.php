...
<?php if (!empty($paitents->consultant_id)) { ?>
	<tr>
		...
		<td class="consssst"> : <?php echo $const_name->dr_name; ?></td>
	</tr>
<?php } ?>
<?php if (!empty($paitents->consul_sec_id)) { ?>
	<tr>
		<th align="left"><?php echo lang('consultant').' '.lang('name'); ?></th>
		<td class="cons_secst"> :  <?php echo $conndnd_name->dr_name; ?></td>
	</tr>
<?php } ?>
	<tr>
		<th align="left"><?php echo lang('doctor').' '.lang('name'); ?></th>
		<td class="dr_n"> : <?php echo $paitents->dr_name; ?></td>
	</tr>
...
<?php } ?>
	...
	<tr>
		...
		<td> : <?php echo $paitents->patient_rand_id; ?></td>
	</tr>
		<tr>
...
<?php foreach ($bills as $bill) { ?>
		<tr>
			...
			<td style="font-size: 13px;" align="right" width="100px"><?php echo $bill->create_bill_taka;
				$total_tk[] = $bill->create_bill_taka; 
